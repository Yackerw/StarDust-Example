...
enum GeneralMaterialFlags {NO_CULLING = 0x0, BACK_CULLING = 0x1, FRONT_CULLING = 0x2, CULLING_MASK = 0x3, TEXTURE_TRANSFORM = 0x4, TEXTURE_NORMAL = 0x8, TEXTURE_POS = 0xC, TEXTURE_MAP_MASK = 0xC, TEXTURE_NORMALMODE_SPHERE = 0x10, TEXTURE_NORMALMODE_SPEC = 0x20};

enum LightingFlags {LIGHT_ENABLE = 0x1, LIGHT_TOON_HIGHLIGHT = 0x2, LIGHT_DECAL_TEXTURE = 0x6, LIGHT_OVERRIDE0 = 0x8, LIGHT_OVERRIDE1 = 0x10, LIGHT_OVERRIDE2 = 0x20, LIGHT_OVERRIDE3 = 0x40, LIGHT_OVERRIDEMASK = 0x78};
